...
{
    public class IncomingDataPreparer2 : IIncomingDataPreparer
    {
        ...
        public IncomingDataPreparer2(int commandTypeLength, int idLength, int dataPackLength, Regex commandPattern, char separator)
        {
        ...
        private int FindSeparatorIndex(int startIndex = 0, int length = 0)
        {
            return _buffer.IndexOf(_separator, startIndex, length == 0 ? _buffer.Length - 1 : length);
        }

...
namespace Shield.HardwareCom.CommandProcessing
{
    ...
    /// </summary>
    public class CommandTranslatorNew : ICommandTranslator
    {
        ...
        public CommandTranslatorNew(IApplicationSettingsModel applicationSettings, Func<ICommandModel> commandModelFac)
        {
            ...
            _commandLengthWithData = _commandLength + _appSettingsModel.DataSize + 1;
        }
        ...
        public ICommandModel FromString(string rawData)
        {
            ...
            if (rawData.Length == _commandLengthWithData || rawData.Length == _commandLength)
            {
                ...
                if (rawData.Length == _commandLengthWithData)
                    rawDataString = rawData.Substring(_commandLength);
        ...
        public string FromCommand(ICommandModel givenCommand)
        {
            ...
            if (givenCommand.CommandType == CommandType.Data)
            {
                ...
                command.Append(_filler, _commandLengthWithData - 1 - command.Length);
                command.Append(_separator);
            }

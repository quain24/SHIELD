...
namespace Shield.Data
{
    ...
    public class AppSettings : IAppSettings
    {
        ...
        private const string FILE_NAME = @"settings2.xml";
        ...
        public bool LoadFromFile()
        {
            ...
            catch (Exception ex)
            {
                ...
                ICommandTypesModel defaultCommandTypesModel = new CommandTypesModel();
                ...
                _appSettingsModel.Settings.Add(SettingsType.CommandTypes, defaultCommandTypesModel);
        ...
        public void Add(SettingsType type, ISetting settings)
        {
        ...
        public ISetting GetSettingsFor(SettingsType type)
        {
            if (_appSettingsModel.Settings.ContainsKey(type))
        ...
        public T GetSettingsFor<T>() where T : class, ISetting
        {
